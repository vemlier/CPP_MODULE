...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/28 11:22:28 by chukim            #+#    #+#             */
/*   Updated: 2022/11/01 07:26:49 by chukim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form & ref)
{
	...
	{
		ref.be_signed(*this);
		std::cout << "Bureaucrat " << _name << " with a grade " << _grade << " succesfully signs " << ref.getName() << std::endl;
	}
	catch (Form::Exception &e)
	{
		std::cout << "Bureaucrat " << _name << " with a grade " << _grade << " cannot sign " << ref.getName() << " because " << e.what() << std::endl;
	}
}
