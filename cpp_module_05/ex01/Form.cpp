...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/28 11:21:53 by chukim            #+#    #+#             */
/*   Updated: 2022/11/01 07:21:00 by chukim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const Form & ref) : _name(ref.getName()), _grade_to_sign(ref.getGradeToSign()), _grade_to_execute(ref.getGradeToExecute()), _signed(ref.getSigned())
{
